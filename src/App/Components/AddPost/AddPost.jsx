...
const AddPost = () => {
    ...
    }, [titleArray, descriptionArray])

    const updatePost = ()=> {
        titleArray.push(titleValue);
        descriptionArray.push(descriptionValue);
        Object.assign(post, {"category":Selectedcategory, "Heading": headingValue, "Title": titleArray, "Description": descriptionArray})
    }
    ...
    const ContentSection = () => {
        return (
            <div className='pt-8 '>
                <p>Title</p>
                <Textarea
                    className='w-full p-2 text-l border' onChange={handleTitleChange}
                />
                <p>Description</p>
                <Textarea
                    className='w-full p-2 text-l p-3 h-48 border' onChange={handleDescriptionChange}
        ...
        <div>
            ...
            <div className='w-full flex'>
                <div className='w-4/5 p-8 addPostContainer'>
                    <h3 className='font-bold text-2xl'>ADD NEW POST</h3>
                    <div className='mt-5'>
                        <p>Heading</p>
                    <Textarea className='w-full p-2 text-l border' onChange={handleHeadingChange}/>
                    </div>

                    {contentSection}
                    <p className='font-bold w-full text-right text-teal pt-4 pb-4' onClick={updatePost}>Update Post</p>
